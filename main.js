...
const createTaskElement = (chooseTaskList) => {
    ...
    for (let i = 0; i < chooseTaskList.length; i++) {
        ...
        if (chooseTaskList[i].taskDate != ""){
            const formatedDate = (0,date_fns__WEBPACK_IMPORTED_MODULE_7__["default"])((0,date_fns__WEBPACK_IMPORTED_MODULE_5__["default"])(chooseTaskList[i].taskDate), "dd-MM-yyyy");
        ...
        if (dateString !== undefined) {
            const formatedDate = (0,date_fns__WEBPACK_IMPORTED_MODULE_7__["default"])((0,date_fns__WEBPACK_IMPORTED_MODULE_5__["default"])(dateString), "dd-MM-yyyy");
...
function switchTabCategory(){
    ...
    const getTab = _task_logic__WEBPACK_IMPORTED_MODULE_3__.taskList.filter(item => item.taskCategory === tabValue);
